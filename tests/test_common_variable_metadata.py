...
runtime_convert_tests = [
    ...
    ["bool -> file", acvi.FileMetadata(), acvi.BooleanValue(True), acvi.IncompatibleTypesException],
    [
        "bool -> bool[]",
    ...
    ["int -> file", acvi.FileMetadata(), acvi.IntegerValue(42), acvi.IncompatibleTypesException],
    [
        "int -> bool[]",
        acvi.BooleanArrayMetadata(),
    ...
    ["real -> file", acvi.FileMetadata(), acvi.RealValue(42.3), acvi.IncompatibleTypesException],
    [
        "real -> bool[]",
        acvi.BooleanArrayMetadata(),
        acvi.RealValue(42.3),
    ...
    # File to ...
    ["file -> bool", acvi.BooleanMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    ["file -> int", acvi.IntegerMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    ["file -> real", acvi.RealMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    ["file -> str", acvi.StringMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    ["file -> file", acvi.FileMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    [
        "file -> bool[]",
        acvi.BooleanArrayMetadata(),
        acvi.EMPTY_FILE,
    ...
    ["file -> real[]", acvi.RealArrayMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    ["file -> str[]", acvi.StringArrayMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    ["file -> file[]", acvi.FileArrayMetadata(), acvi.EMPTY_FILE, acvi.IncompatibleTypesException],
    # Boolean Array to ...
    [
        "bool[] -> bool",
