...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(BooleanValue(True), BooleanValue(True), None, id="BoolValue(True)"),
        pytest.param(BooleanValue(False), BooleanValue(False), None, id="BoolValue(False)"),
        # Integer to Boolean Tests
        pytest.param(
            IntegerValue(
                numpy.iinfo(numpy.int64).min), BooleanValue(True), None, id="IntegerValue(MIN)"),
        pytest.param(IntegerValue(-1), BooleanValue(True), None, id="IntegerValue(-1)"),
        pytest.param(IntegerValue(0), BooleanValue(False), None, id="IntegerValue(0)"),
        pytest.param(IntegerValue(1), BooleanValue(True), None, id="IntegerValue(1)"),
        pytest.param(
            IntegerValue(
                numpy.iinfo(numpy.int64).max), BooleanValue(True), None, id="IntegerValue(MAX)"),
        # Real to Boolean Tests
        pytest.param(RealValue(float("-inf")), BooleanValue(True), None, id="RealValue(-∞)"),
        pytest.param(
            RealValue(-sys.float_info.max), BooleanValue(True), None, id="RealValue(-MAX)"),
        pytest.param(RealValue(-1.0), BooleanValue(True), None, id="RealValue(-1.0)"),
        pytest.param(
            RealValue(-sys.float_info.epsilon), BooleanValue(True), None, id="RealValue(-ε)"),
        pytest.param(
            RealValue(-sys.float_info.min), BooleanValue(True), None, id="RealValue(-MIN)"),
        pytest.param(RealValue(-0.0), BooleanValue(False), None, id="RealValue(-0.0)"),
        pytest.param(RealValue(0.0), BooleanValue(False), None, id="RealValue(0.0)"),
        pytest.param(RealValue(sys.float_info.min), BooleanValue(True), None, id="RealValue(MIN)"),
        pytest.param(
            RealValue(sys.float_info.epsilon), BooleanValue(True), None, id="RealValue(ε)"),
        pytest.param(RealValue(1.0), BooleanValue(True), None, id="RealValue(1.0)"),
        pytest.param(RealValue(sys.float_info.max), BooleanValue(True), None, id="RealValue(MAX)"),
        pytest.param(RealValue(float("inf")), BooleanValue(True), None, id="RealValue(∞)"),
        pytest.param(RealValue(float("nan")), BooleanValue(True), None, id="RealValue(NAN)"),
        ...
        pytest.param(StringValue("Y"), BooleanValue(True), None, id="StringValue(Y)"),
        pytest.param(StringValue("N"), BooleanValue(False), None, id="StringValue(N)"),
