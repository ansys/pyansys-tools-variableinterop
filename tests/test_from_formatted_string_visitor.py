...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("-1", "en-US", integer_value.IntegerValue(-1), id="-1, en-US"),
        pytest.param("-1", "de-DE", integer_value.IntegerValue(-1), id="-1, de-DE"),
        pytest.param("+1", "en-US", integer_value.IntegerValue(1), id="1, en-US"),
        pytest.param("+1", "de-DE", integer_value.IntegerValue(1), id="1, de-DE"),
        pytest.param("9.22337E+18", "en-US", integer_value.IntegerValue(9223370000000000000),
                     id="Max Int, en-US"),
        pytest.param("9,22337E+18", "de-DE", integer_value.IntegerValue(9223370000000000000),
                     id="Max Int, de-DE"),
        pytest.param("-9.22337E+18", "en-US",
                     integer_value.IntegerValue(-9223370000000000000), id="Min Int, en-US"),
...
@pytest.mark.parametrize(
    "value,locale,expected",
    [
        pytest.param("0", "en-US", real_value.RealValue(0), id="0, en-US"),
        pytest.param("0", "de-DE", real_value.RealValue(0), id="0, de-DE"),
        pytest.param("3", "en-US", real_value.RealValue(3), id="3, en-US"),
        pytest.param("3", "de-DE", real_value.RealValue(3), id="3, de-DE"),
        pytest.param("3.14", "en-US", real_value.RealValue(3.14), id="3.14, en-US"),
        pytest.param("3,14", "de-DE", real_value.RealValue(3.14), id="3.14, de-DE"),
        pytest.param("1.79769313486232E+308", "en-US",
                     real_value.RealValue(1.79769313486232e+308), id="Max Value, en-US"),
        pytest.param("1,79769313486232E+308", "de-DE",
                     real_value.RealValue(1.79769313486232e+308), id="Max Value, de-DE"),
        pytest.param("-1.79769313486232E+308", "en-US",
                     real_value.RealValue(-1.79769313486232e+308), id="Min Value, en-US"),
        pytest.param("-1,79769313486232E+308", "de-DE",
                     real_value.RealValue(-1.79769313486232e+308), id="Min Value, de-DE"),
        pytest.param("-INF", "en-US", real_value.RealValue(np.NINF),
                     id="Neg Infinity, en-US"),
        pytest.param("-INF", "de-DE", real_value.RealValue(np.NINF),
                     id="Neg Infinity, de-DE"),
        pytest.param("NAN", "en-US", real_value.RealValue(np.nan), id="NAN, en-US"),
        ...
        pytest.param("2.2250738585072E-308", "en-US",
                     real_value.RealValue(2.2250738585072e-308), id="Epsilon, en-US"),
...
@pytest.mark.parametrize(
    "value,locale,expected",
    [
        pytest.param("True", "en-US", boolean_value.BooleanValue(np.True_), id="True, en-US"),
        pytest.param("True", "de-DE", boolean_value.BooleanValue(np.True_), id="True, de-DE"),
        pytest.param("False", "en-US", boolean_value.BooleanValue(np.False_),
                     id="False, en-US"),
        pytest.param("False", "de-DE", boolean_value.BooleanValue(np.False_),
                     id="False, de-DE"),
        pytest.param("Yes", "en-US", boolean_value.BooleanValue(np.True_), id="True, en-US"),
        pytest.param("Yes", "de-DE", boolean_value.BooleanValue(np.True_), id="True, de-DE"),
        pytest.param("On", "en-US", boolean_value.BooleanValue(np.True_), id="True, en-US"),
        pytest.param("On", "de-DE", boolean_value.BooleanValue(np.True_), id="True, de-DE"),
        pytest.param("1", "en-US", boolean_value.BooleanValue(np.True_), id="True, en-US"),
        pytest.param("1", "de-DE", boolean_value.BooleanValue(np.True_), id="True, de-DE"),
        pytest.param("No", "en-US", boolean_value.BooleanValue(np.False_),
                     id="False, en-US"),
        pytest.param("No", "de-DE", boolean_value.BooleanValue(np.False_),
                     id="False, de-DE"),
        pytest.param("Off", "en-US", boolean_value.BooleanValue(np.False_),
                     id="False, en-US"),
        pytest.param("Off", "de-DE", boolean_value.BooleanValue(np.False_),
                     id="False, de-DE"),
        pytest.param("0", "en-US", boolean_value.BooleanValue(np.False_), id="False, en-US"),
...
@pytest.mark.parametrize(
    "value,locale,expected",
    [
        pytest.param("foo", "en-US", string_value.StringValue("foo"), id="foo, en-US"),
        pytest.param("foo", "de-DE", string_value.StringValue("foo"), id="foo, de-DE"),
        pytest.param("", "en-US", string_value.StringValue(""), id="Empty, en-US"),
        pytest.param("", "de-DE", string_value.StringValue(""), id="Empty, de-DE"),
        pytest.param("Unicode: AÇĎȄЖउႴ〣倊瀇选뀋퀍𝓝𠀠𢀣𤀤𦀦𨀨𪀪", "en-US",
