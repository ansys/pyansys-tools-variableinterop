...
def test_visiting_a_real_formats_correctly(
    value: RealValue, locale: str, expected: np.str_
) -> None:
    """
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(IntegerValue(1), "de_DE.UTF-8", "1", id="1, de_DE"),
        pytest.param(
            IntegerValue(9223372036854775807), "en_US.UTF-8", "9.22337E+18", id="Max Int, en_US"
        ),
        pytest.param(
            IntegerValue(9223372036854775807), "de_DE.UTF-8", "9,22337E+18", id="Max Int, de_DE"
        ),
        pytest.param(
            IntegerValue(-9223372036854775808), "en_US.UTF-8", "-9.22337E+18", id="Min Int, en_US"
        ),
        pytest.param(
            IntegerValue(-9223372036854775808), "de_DE.UTF-8", "-9,22337E+18", id="Min Int, de_DE"
        ),
    ],
)
def test_visiting_a_integer_formats_correctly(
    value: IntegerValue, locale: str, expected: np.str_
) -> None:
    """
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(BooleanValue(np.False_), "en_US.UTF-8", "False", id="False, en_US"),
        pytest.param(BooleanValue(np.False_), "de_DE.UTF-8", "False", id="False, de_DE"),
    ],
)
def test_visiting_a_boolean_formats_correctly(
    value: BooleanValue, locale: str, expected: np.str_
) -> None:
    """
...
def test_visiting_a_string_formats_correctly(
    value: StringValue, locale: str, expected: np.str_
) -> None:
    """
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            IntegerArrayValue((1, 6), [5, 4, 3, 2, 1, -1]),
            "en_US.UTF-8",
            "5,4,3,2,1,-1",
            id="Single dim, en_US",
        ),
...
def test_visiting_an_integer_array_formats_correctly(
    value: IntegerArrayValue, locale: str, expected: str
) -> None:
    """
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            RealArrayValue((1, 3), [5, 4, 3.25]), "en_US.UTF-8", "5,4,3.25", id="Single dim, en_US"
        ),
        pytest.param(
...
def test_visiting_a_real_array_formats_correctly(
    value: RealArrayValue, locale: str, expected: str
) -> None:
    """
...
def test_visiting_a_boolean_array_formats_correctly(
    value: BooleanArrayValue, locale: str, expected: str
) -> None:
    """
...
def test_visiting_a_string_array_formats_correctly(
    value: StringArrayValue, locale: str, expected: np.str_
) -> None:
    """
    Verifies the formatting of various StringValues.
