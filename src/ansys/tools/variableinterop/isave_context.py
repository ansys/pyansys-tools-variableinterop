...
class ISaveContext(AbstractContextManager, ABC):
    ...
    def save_file(self, source: Union[PathLike, str], content_id: Optional[str] = None) -> str:
        ...
        content_id : Optional[str], optional
            Unique ID if it already known for this file. The default value is ``None``.
            If an ID is not provided, one is generated and returned.
            This ID can be used with an equivalent ``ILoadContext`` instance to load the contents
             on deserialize.
...
class ILoadContext(AbstractContextManager, ABC):
    ...
    def load_file(self, content_id: Optional[str]) -> Optional[PathLike]:
        ...
        content_id : Optional[str]
            The id generated by an equivalent ``ISaveContext`` instance to save a file into this
             context.
