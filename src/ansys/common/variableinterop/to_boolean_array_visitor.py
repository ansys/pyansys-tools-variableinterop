...
class ToBooleanArrayVisitor(ivariable_visitor.
    ...
    def visit_integer(self,
                      value: integer_value.IntegerValue) -> boolean_array_value.BooleanArrayValue:
        raise exceptions.IncompatibleTypesException(
            value.variable_type,
            variable_type.VariableType.BOOLEAN_ARRAY)

    def visit_real(self, value: real_value.RealValue) -> boolean_array_value.BooleanArrayValue:
        raise exceptions.IncompatibleTypesException(
            value.variable_type, variable_type.VariableType.BOOLEAN_ARRAY)

    def visit_boolean(self,
                      value: boolean_value.BooleanValue) -> boolean_array_value.BooleanArrayValue:
        raise exceptions.IncompatibleTypesException(
            value.variable_type,
            variable_type.VariableType.BOOLEAN_ARRAY)

    def visit_string(self,
                     value: string_value.StringValue) -> boolean_array_value.BooleanArrayValue:
    ...
    def visit_real_array(self,
                         value: real_array_value.RealArrayValue) \
            -> boolean_array_value.BooleanArrayValue:
        return value.to_boolean_array_value()

    def visit_boolean_array(self,
                            value: boolean_array_value.BooleanArrayValue) \
            -> boolean_array_value.BooleanArrayValue:
        return value

    def visit_string_array(self,
                           value: string_array_value.StringArrayValue) \
            -> boolean_array_value.BooleanArrayValue:
        return value.to_boolean_array_value()
